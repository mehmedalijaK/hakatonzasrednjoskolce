...
<?php
    $json = file_get_contents("izlozbe.json"); # ucitavanje json fajla
...
<body>
 <div class="navbarglavni">
    <nav class="navbar navbar-expand-xl navbar-dark flex-top">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" id = "item">Izložbe</a>
            </li>
            <li class="nav-item">
    ...
    <div class="right">
        <div class="about">
            <h2 class="naslovvrste">IZLOŽBE</h2>
  ...
  <script type="text/javascript">
   ...
   <footer class="footer1">
    ...
    <script src="js/izlozbe.js"></script>	
</body>
</html>