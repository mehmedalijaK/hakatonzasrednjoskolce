    ...
    <nav class="navbar navbar-expand-xl navbar-dark flex-top">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" id = "item" style="color: white;">Koncerti</a>
                </li>
            <li class="nav-item">
...
<script>
        ...
        <?php
        $json = file_get_contents("koncerti.json"); # ucitavanje json fajla
  ...
  <div class="arrange">
    ...
    <div class="right">
        <div class="about">
            <h2 class="naslovvrste">KONCERTI</h2>
  ...
  <footer class="footer1">
    ...
    <script type="text/javascript" src="bootstrap/jquery-3.4.1.min.js"></script>
    <script type="text/javascript" src="bootstrap/js/bootstrap.min.js"></script>
    <script src="js/koncerti.js"></script>    
</body>
</html>